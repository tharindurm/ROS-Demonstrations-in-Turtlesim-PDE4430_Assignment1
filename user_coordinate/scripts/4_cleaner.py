...
#Deleting default 'turtle1' instance form turtlesim using turtlesim services
rospy.wait_for_service('kill')
killer = rospy.ServiceProxy('kill',turtlesim.srv.Kill)
killer("turtle1")

#Spawning new turtle at a corner of the turtlesim using turtlesim services
...
def moveHorizontal(dist):
    ...
    #Having 0 makes the code break. Busy waiting untill the currentPose receives values from the subscriber callback function
    while currentPose.x==0:
        pass

    #Initializing current position and total distance
